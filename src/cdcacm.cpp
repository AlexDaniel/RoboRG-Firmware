...
// TODO clean it up and fix code style

usbd_device *main_usbd_dev = 0;
...
void cdcacm_setup(void) {
    ...
    main_usbd_dev = usbd_init(&st_usbfs_v1_usb_driver, &dev, &config, usb_strings,
                              3, usbd_control_buffer, sizeof(usbd_control_buffer));
    usbd_register_set_config_callback(main_usbd_dev, cdcacm_set_config);
